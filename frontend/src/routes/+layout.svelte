  ...
  <div class="bg-primary-500 text-white py-2 text-sm">
    <div class="container-custom flex justify-between items-center">
      <div class="flex items-center gap-6">
        <a href="tel:+919877505344" class="flex items-center gap-2 hover:text-primary-100 transition-colors">
          <i class="fas fa-phone text-xs"></i>
          <span class="hidden sm:inline">+91-9877505344</span>
        </a>
        <a href="mailto:contact@friends2health.com" class="hidden md:flex items-center gap-2 hover:text-primary-100 transition-colors">
          <i class="fas fa-envelope text-xs"></i>
          <span>contact@friends2health.com</span>
        </a>
      </div>
      <a href="https://wa.me/919877505344" target="_blank" rel="noopener" class="flex items-center gap-2 hover:text-primary-100 transition-colors">
      ...
      <div>
        ...
        <ul class="space-y-3">
          <li class="flex items-start gap-3">
            ...
            <a href="tel:+919877505344" class="hover:text-primary-300 transition-colors">+91-9877505344</a>
          </li>
          <li class="flex items-start gap-3">
            <i class="fab fa-whatsapp text-primary-400 mt-1"></i>
            <a href="https://wa.me/919877505344" target="_blank" rel="noopener" class="hover:text-primary-300 transition-colors">WhatsApp Us</a>
          </li>
          <li class="flex items-start gap-3">
            <i class="fas fa-envelope text-primary-400 mt-1"></i>
            <a href="mailto:contact@friends2health.com" class="hover:text-primary-300 transition-colors">contact@friends2health.com</a>
          </li>
        </ul>
      </div>
    </div>
